...
#define SNAZZCRAFT_GENERATE_PANEL_LONG(X, Y, Texture)  new SnazzCraft::Panel(X, Y, SNAZZCRAFT_PANEL_LONG_WIDTH, SNAZZCRAFT_PANEL_LONG_HEIGHT, Texture)
#define SNAZZCRAFT_GENERATE_PANEL_SHORT(X, Y, Texture) new SnazzCraft::Panel(X, Y, SNAZZCRAFT_PANEL_SHORT_WIDTH, SNAZZCRAFT_PANEL_SHORT_HEIGHT, Texture)
