...
SnazzCraft::MainMenuGUI::MainMenuGUI(unsigned int WindowWidth, unsigned int WindowHeight, GLFWwindow* Window) : SnazzCraft::GUI(WindowWidth, WindowHeight)
{
    ...
    this->WidgetCollections[1]->Panels.push_back(SNAZZCRAFT_GENERATE_PANEL_LONG((int)(WindowWidth / 2.0f) - (int)(SNAZZCRAFT_PANEL_LONG_WIDTH / 2.0f), (int)(WindowHeight / 4), new SnazzCraft::Texture("textures/gui/button.png")));

    this->WidgetCollections[1]->Buttons.push_back(SNAZZCRAFT_GENERATE_BUTTON_LONG((int)(WindowWidth / 2.0f) - (int)(SNAZZCRAFT_PANEL_LONG_WIDTH / 2.0f), (int)(WindowHeight / 4)));
