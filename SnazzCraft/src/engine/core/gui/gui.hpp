...
#include "widget-collection/widget-collection.hpp"
...
namespace SnazzCraft
{
    ...
    public:
        ...
        virtual void HandleLeftMouseClick(SnazzCraft::Event* Event);

        virtual void Resize(unsigned int WindowWidth, unsigned int WindowHeight)
        {
            this->GUIShader->use();
