...
#define SNAZZCRAFT_DATA_TYPE_DVEC2          (0x03)
#define SNAZZCRAFT_DATA_TYPE_SWITCH_MODE    (0x05)
#define SNAZZCRAFT_DATA_TYPE_INT            (0x06)
#define SNAZZCRAFT_DATA_TYPE_BOOL           (0x07)
